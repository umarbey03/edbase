...
async function loadPopularCourses() {
    ...
    try {
        ...
        <div class="bg-white p-4 rounded-xl shadow hover:shadow-lg transition">
          ...
          <p class="text-sm text-gray-600 mb-2">👨‍🏫 <span class="font-medium">${course.instructorName}</span></p>
          <p class="text-sm text-gray-700 mb-2">💰 <span class="font-medium">${priceText}</span></p>
          <p class="text-sm text-yellow-500 mb-4">${ratingStars} (${course.rating})</p>
